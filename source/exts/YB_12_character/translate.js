...
const translate = {
	...
	//出牌阶段限一次,你可以进行一次判定牌不进入弃牌堆的判定,若结果为:♠️️️,你可以视为对一名角色使用一张杀;♥️️️,你可以让一名角色回复一点体力;♦️️️,你可以让一名角色摸两张牌;♣️️️,你可以弃置一名角色的一张牌.然后若本次判定没有出现相同花色,你可以重复之.全部结算之后将这些牌置入弃牌堆.
	sgskjdbzjms_qirang: '祈禳', //出牌阶段,你可以进行一次判定,若结果为:♠️️️,你可以让一名角色多出一张杀;♥️️️,你可以让一名角色回复一点体力;♦️️️,你可以让一名角色摸两张牌;♣️️️,你可以弃置一名角色的一张牌.
	sgskjdbzjms_qirang_info: '出牌阶段限一次,你可以进行一次判定,若结果为:♠️️️,你可以视为对一名角色使用一张杀;♥️️️,你可以让一名角色回复1点体力;♦️️️,你可以让一名角色摸两张牌;♣️️️,你可以弃置一名角色的一张牌',
	sgskjdbzjms_cifu: '赐福',
	...
	sgskjdbzjms_wusheng_info: '你可以将红色牌当【杀】使用或打出,你的♥️️️【杀】伤害+1,♦️️️【杀】无距离限制',
	...
	qmsgswkjsgj_longhun_info: '你可以将同花色的一至两张牌按下列规则使用或打出:♥️️️当【桃】,♦️️️当火【杀】,♣️️️当【闪】,♠️️️当普【无懈可击】.若你以此法转化了两张:红色牌,则此牌回复值或伤害值+1;黑色牌,则你弃置当前回合角色一张牌',
	...
	qmsgswkjsgj_beige_info: '当有角色受到【杀】造成的伤害后,你可以弃一张牌,若此牌花色为:♥️️该角色回复X点体力(X为伤害点数);♦️️︎该角色摸三张牌;♣️️伤害来源弃三张牌;♠️️伤害来源将其武将牌翻面',
	...
	qmsgswkjsgj_shhlianhua_info: '你成为其他角色【杀】的目标后,你摸一张牌,然后进行一次判定,若结果为♠️️️,则取消之',
	qmsgswkjsgj_shhlianhua1: '莲华·改',
	qmsgswkjsgj_shhlianhua1_info: '你成为其他角色【杀】的目标后,你摸一张牌,除非该角色弃置一张牌,否则取消之,然后进行一次判定,若结果为♠️️️,则取消之',
	...
	// qmsgswkjsgj_scsanruo_info: "你可以将一张♥️️牌当【桃】、♦️️牌当火【杀】、♣️️牌当【闪】、♠️️牌当【无懈可击】使用.当你以此法使用或打出【杀】或【闪】时,你可以获得对方的一张牌;当你以此法使用【桃】时,你可以获得一名其他角色的一张牌;当你以此法使用【无懈可击】时,你可以获得此牌响应的普通锦囊牌的使用者的一张牌.",
	// qmsgswkjsgj_scsmiaoyu: "妙语",
	// qmsgswkjsgj_scsmiaoyu_info: "你可以将至多两张相同花色的牌按照以下规则使用或打出:♦️️牌当作火【杀】,♥️️牌当作【桃】,♣️️牌当作【闪】,♠️️牌当作【无懈可击】.若你以此法使用了两张红色牌,则此牌回复值或伤害值+1.若你以此法使用了两张黑色牌,则你弃置当前回合角色一张牌.",
	...
	qmsgswkjsgj_re_dczhubi_info: '当有♦️️牌因弃置而进入弃牌堆后,你可以令一名角色从牌堆或弃牌堆获得一张【无中生有】,然后其可以将【无中生有】置于牌堆顶',
	...
	qmsgswkjsgj_shenci_shhlianhua_info: '你成为其他角色【杀】的目标后,你摸一张牌,除非该角色弃置一张牌,否则取消之,然后进行一次判定,若结果为♠️️️,则取消之',
	...
	qmsgswkjsgj_shenci_shhlianhua2_info: '你成为其他角色牌的目标后,你可以摸一张牌,除非该角色弃置一张牌,否则取消之,然后进行一次判定,若结果不为♥️️️,则取消之',
	...
	// sgsxjxfzmnl_scsanruo_info: "你可以将一张♥️️牌当【桃】、♦️️牌当火【杀】、♣️️牌当【闪】、♠️️牌当【无懈可击】使用.当你以此法使用或打出【杀】或【闪】时,你可以获得对方的一张牌;当你以此法使用【桃】时,你可以获得一名其他角色的一张牌;当你以此法使用【无懈可击】时,你可以获得此牌响应的普通锦囊牌的使用者的一张牌.",
	sgsxjxfzmnl_scsmiaoyu: '妙语',
	sgsxjxfzmnl_scsmiaoyu_info: '你可以将一张♥️️牌当【桃】、♦️️牌当火【杀】、♣️️牌当【闪】、♠️️牌当【无懈可击】使用<span class=firetext>(没写打出,但根据后文以及剧情,应该是有的)</span>.当你以此法使用或打出牌时,你获得一名任意角色牌<span class=firetext>(没说可,就当可吧)</span>',
	...
	sgsxjxfzmnl_xinlonghun_info: '你可以将同花色的一至两张牌按下列规则使用或打出:♥️️️当【桃】,♦️️️当火【杀】,♣️️️当【闪】,♠️️️当普【无懈可击】.若你以此法转化了两张:红色牌,则此牌回复值或伤害值+1;黑色牌,则你弃置当前回合角色一张牌',
	...
	sgsxjxfzmnl_spxizhan_info: '其他角色的回合开始时,你须选择一项:①失去1点体力.②弃置一张牌并令〖芳踪〗于本回合失效,然后若此牌的花色为:♠️️,其视为使用X张【酒】;♥️️,你视为使用X张【无中生有】;♣️️,你视为对其使用【铁索连环】;♦️️:你视为对其使用X张火【杀】(无距离限制).(X为场上阵亡角色数)',
	...
	sgsxjxfzmnl_pyzhuren_shandian_info: '当你使用【杀】指定目标后,可令其进行判定,若结果为:♠️️️,其受到3点雷属性伤害;♣️️️,其受到1点雷属性伤害,你回复1点体力并摸一张牌',
	...
	sgsxjxfzmnl_dclieqiong_place7_info: '令其不能使用或打出♥️️️牌',
	...
	zzrsqlkjygzz_wushen_info: '锁定技,你的♥️️️手牌视为【杀】;你使用♥️️️【杀】无距离和次数限制且不能被响应,且额外选择所有有<梦魇>的角色为目标,伤害+1',
	...
	zzrsqlkjygzz_Eguidao_info: `${get.poptip('rule_chihengji')},受到伤害或流失体力时,可判定:不为♥️️️,防止之并选择一名角色进行〖雷击〗;你的判定牌不可被更改.`,
