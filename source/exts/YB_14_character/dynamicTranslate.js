...
const dynamicTranslate = {
	...
	ybsl_xianyin(player) {
		...
		var str1 = '阳(阳):当你因弃置而失去一张♠️️️牌时,你可令一名角色下个摸牌阶段额外摸一张牌;';
		var str2 = '阳(阴):当你因弃置而失去一张♣️️️牌时,你可令一名角色回复1点体力;';
		var str3 = '阳(阳):当你因弃置而失去一张♥️️️牌时,你可令一名角色失去1点体力;';
		var str4 = '阴(阴):当你因弃置而失去一张♦️️️牌时,你可令一名角色下个摸牌阶段少摸一张牌';
