...
const translate = {
	...
	ybsl_ptqiwu: '栖梧',
	ybsl_ptqiwu_info: '出牌阶段,你可以展示附着火焰的手牌并吸收其火焰;当你受到火属性伤害时,你可以获得双倍火焰;每回合限一次,你可以移除2/5/10枚火焰,然后视为使用回复数值为+0/+1/+2的【桃】;每轮限一次,当你进入濒死状态时,你可以移除40枚火焰,回复体力至上限并摸三张牌',
	...
	ybsl_ptqiwu1: '栖梧一',
	ybsl_ptqiwu1_info: '每回合限一次,你可以移除2枚火焰,然后视为使用回复数值为+0的【桃】',
	ybsl_ptqiwu2: '栖梧二',
	ybsl_ptqiwu2_info: '每回合限一次,你可以移除5枚火焰,然后视为使用回复数值为+1的【桃】',
	ybsl_ptqiwu3: '栖梧三',
	ybsl_ptqiwu3_info: '每回合限一次,你可以移除10枚火焰,然后视为使用回复数值为+2的【桃】',
	ybsl_qygc: '<span class=yellowtext>群友共创第一期</span>',
	ybsl_qygc_info: '<span style="text-decoration: line-through;">但只有夜白一个人的设计</span>喵曹金玉也进行了投稿',
	ybsl_xuyou: '许攸',
	ybsl_zhaosanmusi: '朝三暮四',
	ybsl_zhaosanmusi_info: '出牌阶段,对自己使用.目标角色选择:摸三张牌,然后弃置四张手牌,或弃置三张手牌,然后摸四张牌',
	ybsl_zigong: '自功',
	ybsl_zigong_info: '当你不因此技能获得牌后,你可以弃置这些牌,然后摸等量牌(至多摸五张)',
	ybsl_zicai: '自才',
	ybsl_zicai_info: '当你弃置牌后,根据本次弃牌数,你可以将本次弃置的牌按照以下规则转化:1,火【杀】,2,【调兵遣将】,3,【以逸待劳】,4,【增兵减灶】,5及以上,【朝三暮四】',
	niya_re_liuyan: '鈺刘焉',
	niya_re_liuyan_prefix: '鈺',
	niya_limu: '立牧',
	niya_limu_info: '出牌阶段,你可以将任意花色的牌当指定牌延时锦囊牌对自己使用,♦️️️为乐不思蜀,回复1体力;♠️️️为闪电,然后对一名角色造成1点雷电伤害;♣️️️为兵粮寸断,然后弃置一名角色至多两张牌;♥️️️望梅止渴,然后你摸两张牌.你的判定区有牌时,你对攻击范围内其他角色使用牌无限制',
	niya_limu_info: '出牌阶段,你可以将任意花色的牌当指定牌延时锦囊牌对自己使用,♦️️️为【乐不思蜀】,回复1体力;♠️️️为【闪电】,然后对一名角色造成1点雷电伤害;♣️️️为【兵粮寸断】,然后弃置一名角色至多两张牌;♥️️️【望梅止渴】,然后你摸两张牌.你的判定区有牌时,你对攻击范围内其他角色使用牌无限制',
	niya_tushe: '图射',
	niya_tushe_info: '当你使用或成为非装备牌目标时,你摸x张牌,然后直到本回合结束时,下次发动此技能时手牌须没有基本牌(x为此牌目标数)',
	niya_wangmeizhike: '望梅止渴',
	niya_wangmeizhike_bg: '梅',
	niya_wangmeizhike_info: '对自己使用,置入自己判定区,判定阶段如果不为♦️️️,你选择回复1或者摸两张牌',
	niya_caowei: '鈺曹微',
	niya_caowei_prefix: '鈺',
	niya_youbo: '游波',
	niya_youbo_info: '一名角色失去1点体力时或黑色牌进入弃牌堆时,你可观看牌堆顶x张牌并记录点数之和为a,然后你可摸不大于log以2为底a为真数的最大值数张牌并清除游波记录的点数.以此法摸的牌等于当前回合角色体力上限时,你可减少其1点体力上限.(x为你的体力上限)',
	niya_anren: '暗刃',
	niya_anren_info: '锁定技,你对体力上限不小于你的角色使用牌时其不可响应且造成伤害后额外失去1点体力;你成为体力上限不大于你的角色为目标时,其须弃置一张黑色牌,否则此牌无效',
	niya_xuantu: '玄途',
	...
	ybsl_clanxingzu: '兴族',
	ybsl_clanxingzu_info: '宗族技,当你每回合首次使用一种类型的牌后,若你本回合未造成伤害,你可以令一名同族角色发动一个<出牌阶段限一次>的技能(不计入次数)', //可能些微调整
	//宗族技,当你每回合首次使用一种类型的牌后,若你本回合未造成伤害,你可以令一名同族角色发动一个出牌阶段限一次的技能(不计入次数),或令一名无宗族角色加入你的宗族.
	ybsl_clanqianlei: '谦累',
	ybsl_clanqianlei_info: '宗族技,锁定技,你的阶段被跳过时,你失去1点体力,并选择一名同族角色,然后结束此回合并令该角色执行一个额外回合',
	...
	ybsl_lyyaoe: '夭厄',
	ybsl_lyyaoe_info: '锁定技,当你于回合内使用牌时,若此牌目标包含其他角色,你对自己和目标造成1点伤害',
	...
	ybsl_lytiandu: '天妒',
	ybsl_lytiandu_info: '你猜〖天妒〗啥效果.不出意外的话,此技能仅提供一条语音',
	ybsl_lykangming: '抗命',
	...
	ybsl_ljguihang: '归航',
	ybsl_ljguihang_info: `使命技,锁定技,当你失去手牌后,若你手牌数小于体力上限,你获得【影】补充至体力上限;成功:准备阶段,若你手牌中均为【影】,你弃置所有手牌,获得等量<橘>,并获得技能${get.poptip('nzry_huaiju')},然后摸等量手牌(至多五张),然后增加1点体力上限并回复1点体力.`,
	// 修改后的方案:
	// 姓名:陆绩
	// 体力:3
	// 势力:吴
	...
	ybsl_tuntian: '屯田',
	ybsl_tuntian_info: '当你于回合外失去一张牌时,你可以进行一次判定,若结果不为♥️️️,你可以将其置于武将牌上称为<田>;你计算与其他角色的距离-X(X为你的<田>数)',
	ybsl_quanfan: '劝范',
	...
	ybsl_yedun: '夜遁',
	ybsl_yedun_info: `锁定技,当你每回合首次受到伤害后,你需选择一名其他角色(不能是本局游戏以此法选择过的角色),其需选择:①令你摸三张牌,然后你本回合不能成为黑色牌目标;②令你失去1点体力,然后你本局游戏获得${get.poptip('olshilu')}.`,
	ybsl_yedunx: '夜遁',
	ybsl_yedunx_info: `锁定技,当你每回合首次受到伤害后,你需选择一名其他角色(不能是本局游戏以此法选择过的角色),其需选择:①令你摸三张牌,然后你本回合不能成为黑色牌目标;②令你失去1点体力,然后你本局游戏获得${get.poptip('olshilu')}(可以获得多个).`,
	ybsl_shilu: '失路',
	...
	ybsl_jiangziwen: '蒋歆',
	ybsl_fengci: '封祠',
	ybsl_fengci_info: '每回合限一次,其他角色于其回合内弃置牌后,你可令其将其中每种花色各一张置于你武将牌上称为"祭>,若因此置入了本次弃置的全部牌,其摸本次置入数张牌,此技能本回合视为未发动;摸牌阶段,你可弃置任意张不同花色的<祭>,额外摸等量牌',
	ybsl_fengcix: '封祠',
	ybsl_fengcix_info: '锁定技,其他角色于其回合内弃置牌后,其选择一项:将本次弃置的牌置于你武将牌上称为<祭>;令其本回合下次摸的牌明置且视为【毒】.摸牌阶段,你可弃置任意张不同花色的<祭>,额外摸等量牌',
	ybsl_youxiang: '佑乡',
	ybsl_youxiang_info: '每回合限一次,当其他角色摸牌后,其可以展示本次摸的牌,然后从你的<祭>中选择一张牌获得之,若本次摸牌的花色包含本次选择的"祭>花色,你与其各摸一张牌,然后此技能本回合视为未发动',
	ybsl_youxiangx: '望乡',
	ybsl_youxiangx_info: '锁定技,其他角色不能使用与其上次使用的牌同类型的牌;当你使用牌时,若此牌类型与你上次使用牌的类型不同,你摸一张牌',
	ybsl_suojing: '索靖',
	ybsl_feimo: '飞墨',
	ybsl_feimo_info: '当你使用♣️️️牌后,你可以摸一张牌',
	ybsl_benzhan: '奔战',
	...
	ybsl_yangxu: '羊续',
	ybsl_kanxiao: '堪笑',
	ybsl_kanxiao_info: '蓄力技(1/3).每回合限一次,①当你失去手牌后,你可以消耗1点蓄力值回复1点体力;②当你受到伤害后或失去体力后,你可以消耗1点蓄力值摸两张牌',
	ybsl_shipin: '示贫',
	ybsl_shipin_info: '锁定技,每回合限一次,当你成为牌的目标时,或当你使用牌时若目标不包含你,若你手牌数不大于1,你展示手牌并获得1点蓄力值,若此牌不为锦囊牌,你弃置之并选择将〖堪笑〗或〖示贫〗改为<每回合限两次>',
	ybsl_shichong: '石崇',
	ybsl_shehao: '奢豪',
	ybsl_shehao_info: '转换技,当你使用非虚拟或转化的非装备牌后,你需选择是否:阳:将此牌置入装备区一个空栏;阴:选择装备区一张同类型的牌,然后弃置之并摸X张牌或将之当作触发此技能的牌使用(X为弃置的牌与触发技能使用的牌[花色,点数,牌名字数]相同的项数),以此法使用的牌不计入次数且无次数限制.<br>此技能选是不转,选否才转',
	ybsl_jugu: '巨贾',
	...
	ybsl_simayou: '司马攸',
	ybsl_youyou: '攸攸',
	ybsl_youyou_info: '转换技,每名角色出牌阶段限一次,其可以:①弃置两张手牌(不足不能用),然后令你回复一点体力上限;②回复一点体力,然后令你弃置两张手牌(不足全弃).若不为该角色首次对你发动,则回复改为失去',
	ybsl_shangli: '殇离',
	...
	hairi_zhongxia: '终夏',
	hairi_zhongxia_info: `使命技,当你需要使用一张基本牌时,你可以弃置所有手牌(至少一张),若你以此法弃置的牌花色各不相同,你视为使用之,若你以此法弃置的牌数等于你已损体力值或体力上限,你加1点体力上限(若未成功使用目标牌,此技能本回合不能再用)<br>成功:准备阶段,若你的体力上限不小于5,你选择一项:①获得技能${get.poptip('umi_chaofan')},并回复所有已废除装备栏.②将体力上限调整为1,并重置〖终夏〗.<br>失败:当你死亡时,你令一名其他角色获得〖终夏〗.`,
	ybsl_kamome: '鸥',
	kamome_ybyangfan: '扬帆',
	kamome_ybyangfan_info: '锁定技,游戏开始时,你将一张【旅行箱】置入你的装备区.当你获得此技能时,你分配四张手牌分别标记为<鹰>,<燕>,<隼>,<雀>(离开手牌区则移去标记).当你失去带有标记的牌时或装备区内的牌时,你依次执行:若包含<鹰>,你卜算2;若包含<燕>,你对一名其他角色造成1点伤害;若包含<隼>,你从弃牌堆获得一张与<隼>相同花色的锦囊牌;若包含<雀>你回复1点体力;包含装备区内的牌,你获得牌堆顶X张牌并为这些牌分别标记(X为你手牌中缺少的标记数)(此效果不触发相关技能)',
	kamome_ybyangfan_ying: '鹰·观星',
	kamome_ybyangfan_yan: '燕·伤害',
	kamome_ybyangfan_sun: '隼·捡牌',
	kamome_ybyangfan_que: '雀·回复',
	...
	yb_key_kotori: '界神户小鸟',
	yb_key_kotori_prefix: '界',
	yb_key_kagari: '界篝',
	yb_key_kagari_prefix: '界',
	ybsl_youta: '界成神阳太',
	ybsl_youta_prefix: '界',
	youta_fengshen: '逢神',
	youta_fengshen_info: '锁定技,游戏开始时,若你没有副将,且佐藤雏不在场上,你减少1点体力上限并将佐藤雏作为自己的副将',
	youta_yingshen: '应神',
	...
	ybsl_pujing: '普净',
	ybsl_reshidao: '示刀',
	ybsl_reshidao_info: '场上角色出牌阶段开始时,你可以展示一张手牌或指示装备区内一张牌,令其选择:①其本阶段使用此颜色牌无次数限制,②其本阶段可以将此颜色牌当【杀】使用且不可被闪避.若你选择的牌是装备牌,则其本阶段视为拥有此装备的技能',
	ybsl_shidao: '示刀',
	ybsl_shidao_info: '其他角色出牌阶段开始时,你可以展示一张手牌或指示装备区内一张牌,令其选择:①其本阶段使用此颜色牌无次数限制,②其本阶段可以将此颜色牌当【杀】使用且不可被闪避.若你选择的牌是装备牌,则其本阶段视为拥有此装备的技能',
	ybsl_duhun: '渡魂',
	ybsl_duhun_info: '当其他角色阵亡时,你可令其选择一名非击杀其的角色,令其选择的角色回复1点体力并摸三张牌',
	// 普净
	// 群
	// 4
	// 示刀
	...
	ybsl_xianyin: '弦音',
	ybsl_xianyin_info: `转换技,(括号内的阴阳为${get.poptip('ybsl_luanming')}的形态)<br/>阳(阳):当你因弃置而失去一张♠️️️牌时,你可令一名角色下个摸牌阶段额外摸一张牌;(若你没有〖鸾鸣〗或〖鸾鸣〗已使用则改为黑色牌)<br/>阳(阴):当你因弃置而失去一张♣️️️牌时,你可令一名角色回复1点体力;(若你没有〖鸾鸣〗或〖鸾鸣〗已使用则改为黑色牌)<br/>阴(阳):当你因弃置而失去一张♥️️️牌时,你可令一名角色失去1点体力;(若你没有〖鸾鸣〗或〖鸾鸣〗已使用则改为红色牌)<br/>阴(阴):当你因弃置而失去一张♦️️️牌时,你可令一名角色下个摸牌阶段少摸一张牌.(若你没有〖鸾鸣〗或〖鸾鸣〗已使用则改为红色牌)`,
	ybsl_luanming: '鸾鸣',
	ybsl_luanming_info: '转换技,每回合限一次,你可以弃置一黑一红共两张牌:阳:视为使用其中的黑色牌并额外执行一次;阴:视为使用其中的红色牌并额外执行一次',
	// 'ybsl_luanming_info':'转换技,每回合限一次,当你可以使用牌时,你可以弃置一黑一红共两张牌,然后:阳:视为使用其中的黑色牌并额外执行一次;阴:视为使用其中的红色牌并额外执行一次.<br><span class=yellowtext>注意:此技能不能用于响应其他牌,更不能在别人濒死时用【桃】选择其为目标!</span>',
	// 'ybsl_luanming_append':'注意:此技能不能用于响应其他牌,更不能在别人濒死时用【桃】选择其为目标!',
	//-------------------------------神甄姬
	ybsl_zjzilian: '自怜',
	...
	ybsl_zjsshixiang: '诗想',
	ybsl_zjsshixiang_info: '限定技,回合开始时,你可以弃置所有手牌,然后摸三倍数量的牌(至多九张),并且跳过本回合弃牌阶段',
	//------------界篝
	kagari_ybzongsi: '纵丝',
	...
	//------------界张琪瑛
	xinfu_ybfalu: '法箓',
	xinfu_ybfalu_info: '锁定技,游戏开始时,你获得「紫薇」「后土」「玉清」「勾陈」<span class=yellowtext>「虚无」</span>标记各一个.当你的牌因弃置而进入弃牌堆后,根据这些牌的花色,你获得对应的标记:♠️️️,你获得1枚「紫薇」;♣️️️,你获得1枚「后土」;♥️️️,你获得1枚「玉清」;♦️️️,你获得1枚「勾陈」;<span class=yellowtext>无花,你获得1枚「虚无」.(每种标记至多拥有3个)<br>当除「虚无」外其他标记溢出时,若「虚无」尚未溢出,则改为获得「虚无」</span>',
	xinfu_ybzhenyi: '真仪',
	...
	ybsl_kuangfeng: '狂风',
	ybsl_kuangfeng_info: '<span class=yellowtext>出牌阶段限一次</span>/结束阶段,你可以弃置一张<星>并指定一名角色:直到你的下回合开始,该角色受到火焰伤害时,此伤害+1',
	//------------界佐藤雏
	hina_ybshenshi: '神视',
	...
	//------------界马钧
	xinfu_ybjingxie: '精械',
	xinfu_ybjingxie_info: '出牌阶段,你可以展示一张未强化过的【诸葛连弩】或标准包/军争包/SP包中的防具牌,<span class=yellowtext>【赤兔】,【王追】,【闪电】及其变种牌,【洪水】,【火山】,【朱雀羽扇】及其变种牌,【倚天剑】,【青龙偃月刀】,【铜雀】,【护心镜】</span>,然后对其进行强化.当你处于濒死状态时,你可以重铸一张防具牌,然后将体力回复至1点',
	...
	//--------------------神农
	sgsk_wugu: '五谷',
	sgsk_wugu_info: '出牌阶段限一次,你可以展示你的手牌,若如此做,其他角色依次选择一张获得之,若你以此法失去了所有手牌,你回复1点体力',
	sgsk_changcao: '尝草',
	sgsk_changcao_info: '出牌阶段,你可展示牌堆顶的一张牌并获得之,若为♠️️️,你失去1点体力',
	sgsk_changcaox: '尝草',
	sgsk_changcaox_info: '出牌阶段限X次(X为你体力值且至多为5),你可展示牌堆顶的一张牌并获得之,若为♠️️️,你失去1点体力',
	//--------------------轩辕
	sgsk_xiude: '修德',
	...
	//--------------------少昊
	sgsk_qiongsang: '穷桑',
	sgsk_qiongsang_info: '出牌阶段结束时,若你手牌数为0且至少使用了一张手牌,结束阶段开始时,你可以摸三张牌并回复1点体力',
	// 'sgsk_qiongsang_info':'若你的出牌阶段使用完所有手牌,结束阶段开始时,你摸三张牌并回复一点体力',
	sgsk_qiongsangx: '穷桑',
	sgsk_qiongsangx_info: '若你于出牌阶段内失去了最后一张手牌,结束阶段开始时,你可以摸三张牌并回复1点体力',
	sgsk_qiongsangy: '穷桑',
	sgsk_qiongsangy_info: '出牌阶段结束时,若你没有手牌,结束阶段开始时,你可以摸三张牌并回复1点体力',
	//--------------------颛顼
	sgsk_chuangzhi: '创制',
	...
	//--------------------白虎
	sgsk_huwei: '虎威',
	sgsk_huwei_info: '锁定技,你使用♠️️️牌造成的伤害+1,你使用♣️️️牌的目标+1',
	//--------------------朱雀
	sgsk_zhiyan: '炙炎',
	...
	//--------------------麒麟
	sgsk_decai: '德才',
	sgsk_decai_info: '出牌阶段开始时,你可以令一名体力值少于你的角色回复1点体力或令一名手牌数少于你的角色摸一张牌',
	sgsk_decaix: '德才',
	sgsk_decaix_info: '出牌阶段开始时,你可以选择一名其他角色,若其体力值少于你,其回复1点体力;若其手牌数少于你,其摸一张牌',
	//--------------------东王公
	sgsk_baigong: '拜公',
	sgsk_baigong_info: '锁定技,你始终跳过摸牌阶段;其他角色的摸牌阶段结束时,你获得其一张牌(若触发技能前场上角色数不大于4人且对方牌数比你多,你再获得其一张牌.)',
	sgsk_cangling: '苍灵',
	sgsk_cangling_info: '出牌阶段结束时,若你未于本出牌阶段内使用牌指定过其他角色为目标,则你可以令一名任意角色增加1点体力上限,然后你回复1点体力',
	//--------------------西王母
	sgsk_kunlun: '昆仑',
	sgsk_kunlun_info: '锁定技,当你成为♠️️️牌的目标时,你摸两张牌,然后若你未受伤,你弃两张牌',
	sgsk_huasheng: '化生',
	sgsk_huasheng_info: '出牌阶段结束时,你可以展示一张基本牌或普通锦囊牌,并视为使用', //若你未于本出牌阶段内使用牌指定过其他角色为目标,
	//--------------------踏雷
	sgsk_talei: '踏雷',
	//'sgsk_talei_info':'一名角色的回合开始时,你可令其进行一次判定,若结果为♠️️️2~9,则该角色受到3点无来源雷电伤害',
	sgsk_talei_info: '一名角色的回合开始时,你可令其进行一次【闪电】的判定',
	sgsk_yunyuu: '孕育',
	sgsk_yunyuu_info: '一名角色的♥️️️判定牌生效后,你可以摸一张牌',
	//--------------------瑶姬
	sgsk_yunyu: '云雨',
	sgsk_yunyu_info: '当你受到伤害后,你可以令一名男性角色回复1点体力;当一名男性角色受到伤害后,其可以令你回复1点体力',
	// sgsk_yunyux:'云雨',
	...
	sgsk_mushen: '木神',
	sgsk_mushen_info: '限定技,当你进入濒死状态时,你可以弃置所有牌,回复体力至X,并重置武将牌(X为其中♣️️️牌数)',
	sgsk_mushenx: '木神',
	sgsk_mushenx_info: '限定技,当你进入濒死状态时,你可以弃置所有牌,回复体力至X,并重置武将牌(X为其中♣️️️牌数),若回复值溢出,则增加溢出值的体力上限',
	//--------------------后土
	sgsk_yutu: '御土',
	...
	//--------------------伏羲
	sgsk_yuhan: '御寒',
	sgsk_yuhan_info: '每当你受到一次伤害后,你可以弃置一张牌回复1点体力',
	sgsk_jiabian: '驾辩',
	sgsk_jiabian_info: '当你的判定牌最终生效前,你可以指定该判定牌的点数和花色',
	//--------------------相柳
	sgsk_jiushou: '九首',
	sgsk_jiushou_info: '锁定技,你濒死时,减1点体力上限,并回复体力至上限',
	//--------------------后羿
	sgsk_sheri: '射日',
	sgsk_sheri_info: '锁定技,你使用【杀】无视距离,若目标在你攻击范围内,此【杀】伤害+1,若目标在你攻击范围外,此【杀】不可被闪避',
	//--------------------大禹
	sgsk_zhishui: '治水',
	...
	//--------------------土伯
	sgsk_xuemu: '血拇',
	sgsk_xuemu_info: '每当你受到1点伤害后,你可以弃置任意数量的红色牌,摸双倍的牌',
	sgsk_jiuqu: '九屈',
	...
	sgsk_tianhai_info: '每回合限X次,你可以将一张手牌当作一张装备区内的一张非装备牌使用(X为你装备区内牌数)',
	...
	//--------------------蚩尤
	sgsk_zhanshen: '战神',
	sgsk_zhanshen_info: '锁定技,出牌阶段,每当你使用一张牌后,你须分配1点伤害;回合结束时,若你未于此回合击杀至少一名角色,你失去1点体力',
	sgsk_shizhan: '嗜战',
	sgsk_shizhan_info: '锁定技,当你于出牌阶段使用牌时,若此牌点数为你本阶段使用牌的唯一最大/最小点数,你对一名体力值大于等于你/小于等于你的角色造成1点伤害;回合结束时,若你本回合没有击杀过角色,所有本回合受到过你伤害的其他角色依次对你造成1点伤害',
	//--------------------风后
	sgsk_sinan: '司南',
	sgsk_sinan_info: '锁定技,你的♥️️️判定牌生效后,你回复1点体力',
	sgsk_shence: '神策',
	...
	//--------------------九天玄女
	sgsk_taolue: '韬略', //,若为♠️️️,其失去一点体力
	sgsk_taolue_info: '结束阶段开始时或当你受到伤害后,你可以令一名角色摸一张牌并展示之,若为♥️️️,其回复1点体力',
	sgsk_xuanji: '玄机',
	...
	sgsk_bianjuany: '编绢',
	sgsk_bianjuany_info: '出牌阶段限一次,你可以弃置场上一张牌,然后与失去此牌的角色各摸一张牌',
	//--------------------仓颉
	sgsk_zuoshu: '作书',
	...
	//--------------------释迦牟尼
	sgsk_dianhua: '点化',
	sgsk_dianhua_info: '出牌阶段限一次,你可以将所有手牌交给一名其他角色,然后其选择一项:令一名角色回复1点体力或对一名角色造成1点伤害',
	sgsk_wuwo: '无我',
	...
	bilibiliup_roubaozi: '\u65fa\u4ed4\u8089\u5305', //\u999\u8349\u5305	//\u4e03\u661f\u96e8
	bilibiliup_roubaozi_ab: '\u8089\u5305\u5b50',
	bilibiliup_baitaosuyu: '\u767d\u6843\u9165\u9c7cEidolora', //\u5fe7\u9c7c\u75c7
	bilibiliup_baitaosuyu_ab: '\u767d\u6843\u9165\u9c7c',
	bilibiliup_wanqinsin: '\u5a49\u6c81sin', //\u5c0f\u5a49\u5154
	bilibiliup_wanqinsin_ab: '\u5a49\u6c81',
	bilibiliup_xiyeqianzhi: '\u897f\u91ce\u5343\u679d\u3061\u3048', //\u679d\u58eb\u9f20
	bilibiliup_xiyeqianzhi_ab: '\u897f\u91ce\u5343\u679d',
	bilibiliup_lulinxikoi: '\u9e7f\u4e34\u6eaakoi', //\u9e23\u4e8e\u6708	//\u9e7f\u521d\u96ea
	bilibiliup_lulinxikoi_ab: '\u9e7f\u4e34\u6eaa',
	bilibiliup_xilingna: '\u5e0c\u6624\u5a1cLina', //\u5e0c\u6b27\u6c17
	bilibiliup_xilingna_ab: '\u5e0c\u6624\u5a1c',
	bilibiliup_jiligulu: '\u30b8\u30ea\u30b0\u9732-ruru', //\u8d85\u7231\u9732
	bilibiliup_jiligulu_ab: '\u9732\u9732',
	bilibiliup_maomaobaobao: '\u732b\u732b\u9971\u9971_', //\u949f\u610f\u732b
	bilibiliup_maomaobaobao_ab: '\u732b\u732b\u9971\u9971',
