...
const translate = {
	...
	niya_limu: '立牧',
	niya_limu_info: '出牌阶段,你可以将任意花色的牌当指定牌延时锦囊牌对自己使用,♦️️为乐不思蜀,回复1体力;♠️️为闪电,然后对一名角色造成1点雷电伤害;♣️️为兵粮寸断,然后弃置一名角色至多两张牌;♥️️望梅止渴,然后你摸两张牌.你的判定区有牌时,你对攻击范围内其他角色使用牌无限制',
	niya_limu_info: '出牌阶段,你可以将任意花色的牌当指定牌延时锦囊牌对自己使用,♦️️为【乐不思蜀】,回复1体力;♠️️为【闪电】,然后对一名角色造成1点雷电伤害;♣️️为【兵粮寸断】,然后弃置一名角色至多两张牌;♥️️【望梅止渴】,然后你摸两张牌.你的判定区有牌时,你对攻击范围内其他角色使用牌无限制',
	niya_tushe: '图射',
	niya_tushe_info: '当你使用或成为非装备牌目标时,你摸x张牌,然后直到本回合结束时,下次发动此技能时手牌须没有基本牌(x为此牌目标数)',
	niya_wangmeizhike: '望梅止渴',
	niya_wangmeizhike_bg: '梅',
	niya_wangmeizhike_info: '对自己使用,置入自己判定区,判定阶段如果不为♦️️,你选择回复1或者摸两张牌',
	niya_caowei: '鈺曹微',
	...
	ybsl_tuntian: '屯田',
	ybsl_tuntian_info: '当你于回合外失去一张牌时,你可以进行一次判定,若结果不为♥️️,你可以将其置于武将牌上称为<田>;你计算与其他角色的距离-X(X为你的<田>数)',
	ybsl_quanfan: '劝范',
	...
	ybsl_suojing: '索靖',
	ybsl_feimo: '飞墨',
	ybsl_feimo_info: '当你使用♣️️牌后,你可以摸一张牌',
	ybsl_benzhan: '奔战',
	...
	ybsl_xianyin: '弦音',
	ybsl_xianyin_info: `转换技,(括号内的阴阳为${get.poptip('ybsl_luanming')}的形态)<br/>阳(阳):当你因弃置而失去一张♠️️牌时,你可令一名角色下个摸牌阶段额外摸一张牌;(若你没有〖鸾鸣〗或〖鸾鸣〗已使用则改为黑色牌)<br/>阳(阴):当你因弃置而失去一张♣️️牌时,你可令一名角色回复1点体力;(若你没有〖鸾鸣〗或〖鸾鸣〗已使用则改为黑色牌)<br/>阴(阳):当你因弃置而失去一张♥️️牌时,你可令一名角色失去1点体力;(若你没有〖鸾鸣〗或〖鸾鸣〗已使用则改为红色牌)<br/>阴(阴):当你因弃置而失去一张♦️️牌时,你可令一名角色下个摸牌阶段少摸一张牌.(若你没有〖鸾鸣〗或〖鸾鸣〗已使用则改为红色牌)`,
	ybsl_luanming: '鸾鸣',
	...
	//------------界张琪瑛
	xinfu_ybfalu: '法箓',
	xinfu_ybfalu_info: '锁定技,游戏开始时,你获得「紫薇」「后土」「玉清」「勾陈」<span class=yellowtext>「虚无」</span>标记各一个.当你的牌因弃置而进入弃牌堆后,根据这些牌的花色,你获得对应的标记:♠️️,你获得1枚「紫薇」;♣️️,你获得1枚「后土」;♥️️,你获得1枚「玉清」;♦️️,你获得1枚「勾陈」;<span class=yellowtext>无花,你获得1枚「虚无」.(每种标记至多拥有3个)<br>当除「虚无」外其他标记溢出时,若「虚无」尚未溢出,则改为获得「虚无」</span>',
	xinfu_ybzhenyi: '真仪',
	...
	sgsk_changcao: '尝草',
	sgsk_changcao_info: '出牌阶段,你可展示牌堆顶的一张牌并获得之,若为♠️️,你失去1点体力',
	sgsk_changcaox: '尝草',
	sgsk_changcaox_info: '出牌阶段限X次(X为你体力值且至多为5),你可展示牌堆顶的一张牌并获得之,若为♠️️,你失去1点体力',
	//--------------------轩辕
	sgsk_xiude: '修德',
	...
	//--------------------白虎
	sgsk_huwei: '虎威',
	sgsk_huwei_info: '锁定技,你使用♠️️牌造成的伤害+1,你使用♣️️牌的目标+1',
	//--------------------朱雀
	sgsk_zhiyan: '炙炎',
	...
	//--------------------西王母
	sgsk_kunlun: '昆仑',
	sgsk_kunlun_info: '锁定技,当你成为♠️️牌的目标时,你摸两张牌,然后若你未受伤,你弃两张牌',
	sgsk_huasheng: '化生',
	sgsk_huasheng_info: '出牌阶段结束时,你可以展示一张基本牌或普通锦囊牌,并视为使用', //若你未于本出牌阶段内使用牌指定过其他角色为目标,
	//--------------------踏雷
	sgsk_talei: '踏雷',
	//'sgsk_talei_info':'一名角色的回合开始时,你可令其进行一次判定,若结果为♠️️2~9,则该角色受到3点无来源雷电伤害',
	sgsk_talei_info: '一名角色的回合开始时,你可令其进行一次【闪电】的判定',
	sgsk_yunyuu: '孕育',
	sgsk_yunyuu_info: '一名角色的♥️️判定牌生效后,你可以摸一张牌',
	//--------------------瑶姬
	sgsk_yunyu: '云雨',
	...
	sgsk_mushen: '木神',
	sgsk_mushen_info: '限定技,当你进入濒死状态时,你可以弃置所有牌,回复体力至X,并重置武将牌(X为其中♣️️牌数)',
	sgsk_mushenx: '木神',
	sgsk_mushenx_info: '限定技,当你进入濒死状态时,你可以弃置所有牌,回复体力至X,并重置武将牌(X为其中♣️️牌数),若回复值溢出,则增加溢出值的体力上限',
	//--------------------后土
	sgsk_yutu: '御土',
	...
	//--------------------风后
	sgsk_sinan: '司南',
	sgsk_sinan_info: '锁定技,你的♥️️判定牌生效后,你回复1点体力',
	sgsk_shence: '神策',
	...
	//--------------------九天玄女
	sgsk_taolue: '韬略', //,若为♠️️,其失去一点体力
	sgsk_taolue_info: '结束阶段开始时或当你受到伤害后,你可以令一名角色摸一张牌并展示之,若为♥️️,其回复1点体力',
	sgsk_xuanji: '玄机',
