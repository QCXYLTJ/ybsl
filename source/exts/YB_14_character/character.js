...
const character = {
	//武将格式 :
	//'ybsl_hejiezhe':['female','YB_memory',3,['ybsl_hejie'],[]],//
	...
	//---------------------名将改写
	// 'dzsl_luxun':['male','wu',3,['dzsl_shenhuo','dzsl_buxi','dzsl_shennu'],['rankAdd:junk','rankS:d','name:陆|逊']],//陆逊
	...
	//一将成名
	// bilibiliup_jiangali: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_guanyueliuli: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	bilibiliup_sunyuyou: ['female', 'qun', '1/4/3', ['bilibiliup_miaomiao'], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_shianshan: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_roubaozi: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_baitaosuyu: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_wanqinsin: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_xiyeqianzhi: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_lulinxikoi: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_xilingna: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_jiligulu: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_maomaobaobao: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_wenyuexu: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_xueyuer: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_qingxiaozhi: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_qinian: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_menglingli: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_xueyunshang: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	...
	// bilibiliup_linnannanya: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_wanyue: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_taomoran: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_xiaotaosheng: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_suilin: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_baozai: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_mixieer: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_shishi: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_qingling: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_xiaoaijiang: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_xinqi: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_lushi: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_tutu: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_haitang: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	// bilibiliup_shunhua: ['female', 'qun', 0, [], ['rankAdd:epic', 'rankS:a']],
	//'武将名字':['性别','势力',体力,[技能],[]], //格式内每一样东西都不能缺少,否则无法导入该武将包及其以下内容
};
