...
const translate = {
	...
	ybsl_wenii: '瘟疫',
	ybsl_wenii_bg: '疫',
	ybsl_wenii_info: '出牌阶段,对任意角色使用.判定时,若不为♦️️,则获得一张【毒】,然后移给下家,若为♦️️,则移给下家',
	...
	ybsl_guoshishengpao_info: '锁定技,♥️️【杀】对你无效,手牌上限+2',
	// 'ybsl_jinyin':'金银褥铠',
	// 'ybsl_jinyin_bg':'褥',
	// 'ybsl_jinyin_info':'待定',
	// 'ybsl_fengshem':'风神盾',
	...
	ybsl_tianleiyubi_info: '出牌阶段开始时,你可以令一名角色横置或解除横置.<br>出牌阶段结束时,你可以重铸一张手牌.若此牌为红色且你的体力值小于手牌数,你回复1点体力;若此牌不为红色且你手牌数小于体力值,你摸一张牌.<br>结束阶段开始时,你可以进行一次判定,若结果为黑色,你令一名其他角色进入横置状态,并对其造成1点雷电伤害.<br>场上角色准备阶段开始时,你可以令其令其进入横置状态并令其判定,若结果为♠️️2~9,则其受到3点无来源雷电伤害',
	rewrite_ybsl_tianleiyubi: '神雷玉璧',
	rewrite_ybsl_tianleiyubi_bg: '雷',
	rewrite_ybsl_tianleiyubi_info: '出牌阶段开始时,你可以令一名角色横置或解除横置.<br>出牌阶段结束时,你可以重铸一张手牌.若此牌为红色且你的体力值小于手牌数,你回复1点体力;若此牌不为红色且你手牌数小于体力值,你摸一张牌.<br>结束阶段开始时,你可以进行一次判定,若结果为黑色,你令一名其他角色进入横置状态,并对其造成1点雷电伤害.<br>场上角色准备阶段开始时,你可以令其令其进入横置状态并令其判定,若结果为♠️️2~9,则其受到3点无来源雷电伤害.<br>每当你造成1点雷电伤害后,你可以回复1点体力或摸一张牌',
	rewrite_tongque: '界铜雀',
	...
	// 'rewrite_ybsl_jiangjunpifeng_info':'锁定技,当你受到伤害时,取消该次伤害,然后进行一次判定,若为♠️️,则弃置此牌',
	// 'ybsl_liujinguan':'鎏金冠',
