...
const translate = {
	...
	ybsl_tianleiyubi_skill_info: '场上角色准备阶段开始时,你可以令其进入横置状态并令其判定,若结果为♠️️️2~9,则其受到3点无来源雷电伤害',
	...
	ybsl_wenii: '瘟疫',
	ybsl_wenii_bg: '疫',
	ybsl_wenii_info: '出牌阶段,对任意角色使用.判定时,若不为♦️️️,则获得一张【毒】,然后移给下家,若为♦️️️,则移给下家',
	...
	//--------------------------防具
	rewrite_huxinjing: '护心铠',
	rewrite_huxinjing2: '护心铠',
	rewrite_huxinjing_info: '此牌可对其他角色使用.当你受到伤害时,若伤害值大于1或大于等于你的体力值,则你可以将所有【护心铠】退化为【护心镜】,然后防止此伤害.此牌不会被无效,不能被弃置',
	rewrite_huxinjing_info_guozhan: '当你受到伤害时,若伤害值大于等于你的体力值,则你可以将所有【护心铠】退化为【护心镜】,然后防止此伤害.此牌不会被无效,不能被弃置',
	...
	ybsl_guoshishengpao_info: '锁定技,♥️️️【杀】对你无效,手牌上限+2',
	// 'ybsl_jinyin':'金银褥铠',
	// 'ybsl_jinyin_bg':'褥',
	// 'ybsl_jinyin_info':'待定',
	// 'ybsl_fengshem':'风神盾',
	...
	ybsl_taoyao: '桃之夭夭',
	ybsl_taoyao_info: '你可以将一张♥️️️牌当【桃】使用',
	...
	ybsl_tianleiyubi_info: '出牌阶段开始时,你可以令一名角色横置或解除横置.<br>出牌阶段结束时,你可以重铸一张手牌.若此牌为红色且你的体力值小于手牌数,你回复1点体力;若此牌不为红色且你手牌数小于体力值,你摸一张牌.<br>结束阶段开始时,你可以进行一次判定,若结果为黑色,你令一名其他角色进入横置状态,并对其造成1点雷电伤害.<br>场上角色准备阶段开始时,你可以令其令其进入横置状态并令其判定,若结果为♠️️️2~9,则其受到3点无来源雷电伤害',
	rewrite_ybsl_tianleiyubi: '神雷玉璧',
	rewrite_ybsl_tianleiyubi_bg: '雷',
	rewrite_ybsl_tianleiyubi_info: '出牌阶段开始时,你可以令一名角色横置或解除横置.<br>出牌阶段结束时,你可以重铸一张手牌.若此牌为红色且你的体力值小于手牌数,你回复1点体力;若此牌不为红色且你手牌数小于体力值,你摸一张牌.<br>结束阶段开始时,你可以进行一次判定,若结果为黑色,你令一名其他角色进入横置状态,并对其造成1点雷电伤害.<br>场上角色准备阶段开始时,你可以令其令其进入横置状态并令其判定,若结果为♠️️️2~9,则其受到3点无来源雷电伤害.<br>每当你造成1点雷电伤害后,你可以回复1点体力或摸一张牌',
	rewrite_tongque: '界铜雀',
	...
	// 'rewrite_ybsl_jiangjunpifeng_info':'锁定技,当你受到伤害时,取消该次伤害,然后进行一次判定,若为♠️️️,则弃置此牌',
	// 'ybsl_liujinguan':'鎏金冠',
