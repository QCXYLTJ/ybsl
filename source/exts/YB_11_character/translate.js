...
const translate = {
	...
	//<br><li>${get.poptip("yhky_dcchanjuan")}改为:${get.poptip("rule_chihengji")}.当其他角色于你的回合内使用牌时,你移去6点魅力值,然后依次执行①摸一张牌;②令此牌基础伤害或回复值+1;③使其本回合获得${get.poptip("wushuang")}.
	yhky_dchuayan_info:
		get.poptip('rule_chihengji') +
		'.限定技,出牌阶段,你可以进入<' +
		get.poptip({
			id: 'yhky_dcjuewu',
			name: '绝舞',
	...
	//,且场上角色的<酒>状态回合结束不移除
	yhky_dcchanjuan: '婵娟',
	yhky_dcchanjuan_info: get.poptip('rule_chihengji') + '.当其他角色于你的回合内使用牌时,你可以选择①摸一张牌;②令此牌基础伤害或回复值+1;③使其本回合获得' + get.poptip('wushuang') + ';④' + get.poptip('rule_beishui') + ':移去6点魅力值', //当有角色进入或脱离【酒】状态时,你可以摸一张牌(这句作废).
};
