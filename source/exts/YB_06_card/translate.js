...
const translate = {
	...
	boss_honglianx: '红莲',
	boss_honglianx_info: '锁定技,你的红色牌不计入你的手牌上限;你的回合开始时,随机获得牌堆中零到三张红色牌,然后随机对3到0名其他角色各造成1点火属性伤害',
	boss_yanyu: '炎狱',
	...
	boss_sipu: '司圃',
	boss_sipu_switch: '司圃',
	boss_sipu_info: '体力值首次减少至一半或更少时激活此技能.锁定技,你的出牌阶段内,若你使用的牌数小于等于两张,其他角色无法使用或打出牌',
	boss_wuzang: '无脏',
	...
	boss_zhongdu: '中毒',
	boss_zhongdu_bg: '毒',
	boss_zhongdu_info: '锁定技,回合开始时,你进行判定,若结果不为♥️️️,你受到1点无来源的伤害,若结果不为♠️️️,你失去此技能',
	boss_qingyi: '青仪',
	...
	boss_qixiang1: '祺祥',
	boss_qixiang2: '祺祥',
	boss_qixiang_info: '乐不思蜀判定时,你的♦️️️判定牌视为♥️️️;兵粮寸断判定时,你的♠️️️判定牌视为♣️️️',
	qiwu: '栖梧',
	qiwu_info: '锁定技.每当你使用一张♣️️️牌,你回复1点体力',
	jizhen: '激阵',
	...
	boss_beiming: '悲鸣',
	boss_beiming_info: '锁定技,当你死亡时,你令击杀你的角色弃置所有手牌',
	boss_guimei: '鬼魅',
	...
	tinqin: '听琴',
	boss_guihan: '归汉',
	boss_guihan_info: '限定技,濒死阶段,你可以将体力回复至体力上限,摸四张牌,令所有敌人的技能回复,失去技能〖悲歌〗和〖胡笳〗,并获得技能〖听琴〗、〖蕙质〗',
	boss_huixin: '蕙质',
	...
	boss_bingfeng: '冰封',
	boss_bingfeng_info: '锁定技,你死亡时,若击杀你的角色武将牌是正面朝上, 你令其翻面',
	...
	boss_wanghun: '忘魂',
	boss_wanghun_info: '锁定技,你死亡时,令随机两名敌方角色各随机失去一个技能(主公技除外),并在牌堆中加入两张回魂.(回魂只能在挑战模式出现)',
	boss_wangshi: '往事',
	...
	*/
	...
	boss_shuhun: '蜀魂',
	boss_shuhun_info: '锁定技,你造成伤害后,令随机一名友方角色回复1点体力',
	boss_yingji: '影戟',
	...
	boss_qiwu: '栖梧',
	boss_qiwu_info: '每当你使用一张♣️️️牌,你可以令一名友方角色回复1点体力',
	boss_tianyujg: '天狱',
	...
	boss_skonghun: '控魂',
	boss_skonghun_info: '出牌阶段开始时,若你已损失体力值不小于敌方角色数,你可以对所有敌方角色各造成1点雷电伤害,然后你回复X点体力(X为受到伤害的角色数)',
	boss_fanshi: '反噬',
