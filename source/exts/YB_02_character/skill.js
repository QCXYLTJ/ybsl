...
const skill = {
	...
	yb041_sange: {
		...
		content() {
			...
			event.cards = player.getCards('s', function (card) {
				return card.hasGaintag('_ybsl_sixart');
			});
			('step 1');
	...
	yb014_shifu2: {
		...
		content() {
			...
			for (let j of list7) {
				...
				if (player.storage.yb014_shifu2 >= (player.storage['ybsl_' + j + '_lv'] + 1) * game.checkMod(event, player, 0, 'ybsl' + j + 'Mod', player) && player.storage['ybsl_' + j + '_lv'] < game.checkMod(event, player, 0, 'ybsl' + j + 'lvMod', player)) {
					player.addMark('ybsl_' + j + '_lv');
					switch (j) {
						case 'moon':
							lib.skill.ybsl_moon.up(player);
							break;
						case 'clam':
							lib.skill.ybsl_clam.up(player);
							break;
						case 'lightning':
							lib.skill.ybsl_lightning.up(player);
							break;
						case 'wind':
							lib.skill.ybsl_wind.up(player);
							break;
						case 'flame':
							lib.skill.ybsl_flame.up(player);
							break;
					}
				}
			}
		...
		upc() {
			...
			switch (event.num) {
				case 0:
					...
					break;
				case 1:
					event.list66.push('kengo_weishang');
					break;
				case 2:
					event.list66.push('chihaya_youfeng');
					break;
				case 3:
					event.list66.push('drlt_zhiti');
					break;
				case 4:
					event.list66.push('fuping');
					break;
				case 5:
					if (player.storage.yb014_shifu99[0] == '') {
						...
						next.setContent(function () {
							...
							event.list000 = list2;
							player.chooseControl().set('choiceList', list).set('prompt', '请选择分支');
							('step 1');
		...
		upc() {
			...
			switch (event.num) {
				case 0:
					...
					break;
				case 1:
					event.list66.push('ollongdan');
					break;
				case 2:
					event.list66.push('shanduan', 'yilie');
					break;
				case 3:
					event.list66.push('jijiu', 'ollianhuan');
					break;
				case 4:
					event.list66.push('rehuoji', 'rekanpo');
					break;
				case 5:
					event.list66.push('rejiaozhao', 'redanxin');
					break;
				case 6:
					event.list66.push('relonghun');
					break;
				case 7:
					event.list66.push('haruka_shuangche');
					break;
			}
			('step 2');
		...
		upc() {
			...
			switch (event.num) {
				case 0:
					...
					break;
				case 1:
					event.list66.push('nsguidao');
					break;
				case 2:
					event.list66.push('nstaiping');
					break;
				case 3:
					event.list66.push('chouce');
					break;
				case 4:
					event.list66.push('oltuntian');
					break;
				case 5:
					event.list66.push('rin_baoqiu');
					break;
				case 6:
					event.list66.push('bazhen');
					break;
				case 7:
					event.list66.push('jijing');
					break;
			}
			('step 2');
		...
		upc() {
			...
			switch (event.num) {
				case 0:
					...
					break;
				case 1:
					event.list66.push('xinfu_ybfalu', 'xinfu_ybzhenyi');
					break;
				case 2:
					event.list66.push('dchuishu');
					break;
				case 3:
					event.list66.push('dcyishu');
					break;
				case 4:
					event.list66.push('xinfu_ybdianhua');
					break;
				case 5:
					event.list66.push('rumi_shuwu');
					break;
				case 6:
		...
		upc() {
			...
			switch (event.num) {
				case 0:
					...
					break;
				case 1:
					event.list66.push('tianyi', 'tanhu');
					break;
				case 2:
					event.list66.push('relieren');
					break;
				case 3:
					event.list66.push('zhuandui');
					break;
				case 4:
					event.list66.push('mingfa', 'dahe');
					break;
				case 5:
