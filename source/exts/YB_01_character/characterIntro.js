...
const characterIntro = {
	...
	*/
	...
	ybsl_037diamondqueen: '<span class=thundertext>♦️️️Q,记2022年9月29日之30日的一场梦.<br></span>',
	...
	ybsl_083xiaozhu: '<span class=thundertext>小筑,记2023年5月30日之31日梦.由于未能及时记录导致梦境遗忘较多,只记得这个姑娘擅长搭建建筑,但被风一吹就散架回复原样.</span>',
	//047 张汨原位置,新角色待定
	...
	ybsl_086GJ: '<span class=thundertext>龚洁,大约2014年左右,在自由幻想手游相识.我们都选择了<药师>职业,且昵称都包含<雨>字,并且经交流,我们年纪相仿.因为游戏有结拜,结婚等玩法.当时正巧她发起比武招亲.<br>当时许是想看看结婚后的游戏内容,也或许是看了师傅和师娘的婚礼,我参与了比武招亲.其实就是我和对方单挑.将她打败之后,视为我对她发起求婚,她欣然同意.这时我才知道,筹办婚礼居然要男方筹集资金,我记得好像是1888钻石还是多少忘了.不过这个资金貌似可以由男方全款,也可以众筹.<br>为了这点资金,我请求了师傅,结拜的其他兄弟们,忘记有没有变卖装备了.反正终于筹集够了资金.<br>攒够了资金,于是便开始婚礼:婚辇从主城左上一路缓缓走向右下,她在婚辇里,我则在婚辇外不停地散发喜糖————其他角色可以捡拾喜糖,获得少许钻石.师傅师娘,结拜兄弟,以及众宾客,边捡拾喜糖,边发出祝福,BGM也是喜庆无比.<br>后来其他结拜兄弟头像都灰了,很久不上线了.我们后来也没有闲暇时间了,于是加了vx后也退了游.<br>后来她拉我去玩<凤凰心计>,也是有结婚玩法的,也是组建了结婚关系.不过没有浩大的婚礼就是了.游戏有部分内容是:购买小药剂,对对方立绘使用加亲密度(还是什么数值忘了)如果用在正确的地方则会效果拔群.<br>再后来因为繁忙,她也很少上号了.对方不在线则无法进行药剂玩法,不过游戏有一种铃铛道具,使用后可以强行唤醒,然后就可以使用药剂了.<br>再后来我也玩累了,也或者学业繁忙,也离开了.现在那个号也找不到了.不过我们也有qq和vx的联系方式,逢年过节也互道祝福.之后得知她在现实有了男朋友.也不知道两个小毛孩子的死定终生,在她的世界占了对少比重,不过那段纯粹真挚的情谊一直印在我心底.</span>',
