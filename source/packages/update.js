...
window.ybslb_update = {
	...
	'5.7.0-3.0': {
		changeLog: [
			...
			'- 仙诸葛果修复无差别摸牌光环的bug',
			'- 修复扶汉函数的问题',
			'- 修复兴族和戎戒(发动出限一技能不生效的问题)',
			'- 修复谑言ai对敌人发动的bug',
			'- 优化中流函数',
			'- 经狂神优化,将生成器改成了async,并且async函数进行规范化',
			'- 修复盛妍掷郁的ai的bug(也许修了)',
			'- 自动导入至十周年UI素材,可以手动覆盖新资源',
			'- 修复孙立新扼喉bug',
			'- 修复雷魔鹰的bug',
			'- 修复名许褚裸衣bug',
			'- 修复接单赵云龙缨(拷打某个神秘人)',
			...
			'- bilibiliup的角色信息',
			'- 陈往修复濒死吃桃报错的bug',
			'- 修复恒曹婴裸衣等问题以及其他= await w+.draw的问题',
			'- 林安技能肘飞(因为进入了太虚)',
			'- 优化入梦技能.氪系列武将继续画饼',
			'- 配置信息',
			'- get.type改写,为了律法锦囊牌的预热',
			'- 白虎镜改成护心铠并重做',
			'- 转化卡也许是有意思的,但是还有个锦囊叫暗度陈仓……',
			'- 一个给单主写的代码,由于单主很久以前失联,因此兼并进来,以期复用',
			'- 伏羲技能加描述',
			'- 也许有其他隐形bug被修复或添加',
			'------------注意事项------------',
			'- 本扩展需本体版本为1.11.3以上,建议最新版!',
	...
	'5.7.0-1.12': {
		changeLog: [
			...
			//,紫虚,甄宓,关羽,诸葛亮,赵云
			'- 新武将:三国杀同人小说一堆武将',
			'- 全民三国杀,我开局神郭嘉:界鲁肃,界蔡文姬,界曹叡,界张绣,界伏皇后,缝神甘宁,界孙寒华,神国神赵云,神司马懿',
			'- 三国杀仙界下凡怎么你了:阴间十常侍,阴间神荀彧,阴间神张飞,阴间武诸葛,阴间谋曹丕,阴间高达一号,阴间南华老登(手杀),魔吕布,阴间张嫙,阴间神马超,阴间曹金玉,阴间孙寒华',
			'------------修复相关------------',
			'- 小红加强,修复刘域枫求教bug,孙韶id修改,修复曹微、瑶姬、风后的bug,优化糖',
			'- 花朵改为基本牌,♣️️️修改效果,所有花朵移除追加效果',
			'- 搬运本体已拆除的卡包',
			'- 仙界前缀改为阴间,颜色也改为黑紫色',
			'- 修复大风、落雷.万钧神弩的描述错误',
			'- 感谢神秘人的修复:',
			...
			'-- 修改一些错别字',
			'-- 将部分【火杀】【雷杀】改为火【杀】雷【杀】',
			'-- 将部分流失体力改为失去体力,将部分回复体力改为回复体力',
			'-- 转换技描述优化',
			'-- 修复名奸雄,执槊,名反馈,名穆穆的bug',
			'------------注意事项------------',
			'- 本扩展需本体版本为1.10.17.3以上,建议最新版!',
			'- 开启云中守望情况下,屏蔽傀夜白和名神曹丕',
			'- 修复若干bug,可能添加若干bug',
			'- 晶的水剑元交换位置部分仍旧有点bug,无法发动,还望体谅',
			'------------鸣谢清单------------',
	...
	'5.7.0-1.11': {
		changeLog: [
			...
			'------------更新详情------------',
			'- 新武将:孙立新,玺',
			'- 新武将:蒋歆,鸥,仓颉,九天玄女,螺祖,常先,鬼臾区',
			'- 新武将:名张辽,名郭嘉.名许褚改技能',
			'- 接受投稿:恒曹婴,曹微,刘焉',
			'- 新武将:三国杀同人小说一堆武将',
			'- 全民三国杀,我开局神郭嘉:鬼刘备,鬼周瑜,缝神诸葛,旧谋黄忠,界骆统,界杨彪,界刘焉',
			'- 三国杀仙界下凡怎么你了:仙界王元姬,仙界神郭嘉,仙界神甘宁,仙界界沮授,仙界文鸯',
			'------------修复相关------------',
			'- 修复名曹操,忘记修啥了,',
			'- 修复名司马懿,鬼才后半段(没测,有bug还请反馈),',
			'- 优化醋,选目标限制优化',
			'- 优化小红,修复盐',
			'------------注意事项------------',
			'- 本扩展需本体版本为1.10.17.3以上,建议最新版!',
