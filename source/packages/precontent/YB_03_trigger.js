		...
		lib.arenaReady.push(function () {
			if (lib.config.YB_guixiecifu) {
				...
				lib.characterSort.YB_boss = {
					...
					boss_yanluo: ['boss_qinguangwang', 'boss_chujiangwang', 'boss_songdiwang', 'boss_wuguanwang', 'boss_yanluowang', 'boss_bianchengwang', 'boss_taishanwang', 'boss_dushiwang', 'boss_pingdengwang', 'boss_zhuanlunwang', 'boss_dizangwang'],
					boss_xiongshou: ['boss_hundun', 'boss_qiongqi', 'boss_taotie', 'boss_taowu', 'boss_xiangliu', 'boss_zhuyan', 'boss_bifang', 'boss_yingzhao'],
				};
