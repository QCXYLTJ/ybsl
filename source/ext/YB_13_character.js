...
import { characterSort } from '../exts/YB_13_character/characterSort.js';
import { character } from '../exts/YB_13_character/character.js';
import { characterIntro } from '../exts/YB_13_character/characterIntro.js';
import { perfectPair } from '../exts/YB_13_character/perfectPair.js';
import { characterTitle } from '../exts/YB_13_character/characterTitle.js';
import { characterCopyright } from '../exts/YB_13_character/characterCopyright.js';
import { characterCitetext } from '../exts/YB_13_character/characterCitetext.js';
import { characterUndertext } from '../exts/YB_13_character/characterUndertext.js';
import { skill } from '../exts/YB_13_character/skill.js';
import { card } from '../exts/YB_13_character/card.js';
import { translate } from '../exts/YB_13_character/translate.js';
import { dynamicTranslate } from '../exts/YB_13_character/dynamicTranslate.js';
import { typeimage } from '../packages/function.js';
game.import('character', function (lib, game, ui, get, ai, _status) {
	/** @type { importCharacterConfig } */
	const ybwhjx = {
		name: 'ybwhjx', //武将包命名(必填)
